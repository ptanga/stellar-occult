...
3. running of the main function :
    a. calibration of the telescope
      i. control of the star's visibility
      ii. control of the telescope's accuracy
      iii. capture of a control picture
    b. capture of a stream
      i. setup of the stream parameters
      ii. recording of the telescope
    c. parking of the telescope
